package meshki.studio.negarname.services.alarm
...
import meshki.studio.negarname.ui.app.AppActivity
import timber.log.Timber
import meshki.studio.negarname.R
import meshki.studio.negarname.services.notification.NotificationAction
import meshki.studio.negarname.services.notification.NotificationChannel
import meshki.studio.negarname.services.notification.NotificationData
import meshki.studio.negarname.services.notification.NotificationService
                ...
                ACTION_ALARM_SHOW -> {
                    ...
                    if (title.isNotEmpty() && text.isNotEmpty()) {
                        ...
                        val notificationData = NotificationData(
                            ...
                            text = text,
                            channel = NotificationChannel("ALARMS_CHANNEL", "Alarms"),
                            critical = critical,
                            sticky = true,
